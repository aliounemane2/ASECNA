<?php
   ...
   require_once("../_Init_file.php");
		...
		$Tab_param=array(
						'LANGUE_NOM'=>strip_tags($_POST['LANGUE_NOM']),
						'LANGUE_ORALE'=>strip_tags($_POST['LANGUE_ORALE']),
						'LANGUE_ECRITE'=>strip_tags($_POST['LANGUE_ECRITE']),
						'LANGUE_LECTURE'=>strip_tags($_POST['LANGUE_LECTURE']),
