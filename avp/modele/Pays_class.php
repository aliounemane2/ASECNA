...
function GetCh_nom_pays(){return $this->champ_nom_pays;}
	...
	function getPaysBy_nom_pays($critere)
	{
		$Cnn=$this->ma_connexion();
		
		$critere=strtoupper($critere);
	
		$req="SELECT * FROM ".$this->Get_table_pays()." WHERE  ".$this->GetCh_nom_pays()."  LIKE '".$critere."%' LIMIT 0, 30 ";
