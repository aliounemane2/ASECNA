...
function lister_formation($cle="",$trie="ASC",$nbre_enreg="")
  ...
  function lister_form_By_CAND_ID($cle="",$trie="ASC",$nbre_enreg="")
  {
  ...
  function lister_derniere_formation($fk_candidat){
	  
	   $Cnn=$this->ma_connexion();
	  
	   $Req=sprintf("SELECT * FROM  ".$this->Get_table_formation()." WHERE  ".$this->GetCh_FK_CANDIDAT_ID()."=%s  ORDER BY ".$this->GetCh_FORMATION_ID()."  DESC ",
	   $this->GetSQLValueString($fk_candidat,"int"));
  ...
  function lister_formation_candidat_type($fk_candidat,$type)
  {
       $Cnn=$this->ma_connexion();
	   
	   $Req=sprintf("SELECT * FROM  ".$this->Get_table_formation()." WHERE  ".$this->GetCh_Type()."=%s  AND ".$this->GetCh_FK_CANDIDAT_ID()."=%s ",
...
function modifier_enreg_formation($param,$Cnn)
  {
	...
	$this->GetSQLValueString($param['FORMATION_CYCLE'], "text"),
	$this->GetSQLValueString($param['FORMATION_DIPLOME_FICHIER'], "text"),
	$this->GetSQLValueString($param['FORMATION_ID'], "text"));
