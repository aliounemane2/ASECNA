...
// permet de comparer deux nombres
jQuery.validator.addMethod('greaterThan', function(value, element, param) {
    return (
        (
            (isNaN( $(param).val()) &&  isNaN( value )) &&
                ($(param).val() != "" && value != "") ||
                ($(param).val() == "" && value == "" ) ||
                ($(param).val() != "" && value == "")
            ) || (
            (!(isNaN( $(param).val()) && isNaN( value )) &&
                ($(param).val() != 0 && value != 0) ||
                ($(param).val() == 0 && value == 0)) &&
                (parseInt($(param).val()) <= parseInt(value))
            )
        );
}, jQuery.validator.format('Must be greater or equal than the min value'));


// Permet de controller la taille des elements uploader
...
}, jQuery.validator.format("Taille dépassée : Limite {0}{1}"));
...
jQuery.validator.addMethod("accept", function(value, element, param) {
	...
	return true;
}, jQuery.validator.format("entrez une extension valide."));
