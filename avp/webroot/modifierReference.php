...
if(isset($_REQUEST['id_ref']))
{
    ...
    $sql ='SELECT * FROM reference WHERE REF_ID='.$id_ref;
...
if($var <> ""){
    ...
    $sql = "UPDATE reference SET REF_NOM_ENT= '".$_POST['REF_NOM_ENT']."', REF_PERS_CONT = '".$_POST['REF_PERS_CONT'].
        "', REF_POST_OCC = '".$_POST['REF_POST_OCC']."', REF_TEL = '".$_POST['REF_TEL']."' , REF_EMAIL = '".$_POST['REF_EMAIL']."' WHERE REF_ID=".$_POST['id_ref'];
...
<form action="index.php?url=modifierReference"  id="myformannonce" name="annonce" method="post" enctype="multipart/form-data">
    ...
    <fieldset>
        <table>
            ...
            <tr>
                ...
                <td><input type="text" name="REF_NOM_ENT" placeholder="" size="30" value="<?php echo $result['REF_NOM_ENT'];?>" >
                    : </td>
            </tr>
            <tr>
                <th align="right">Nom de la personne &agrave; contacter : </th>
                <td><input type="text" name="REF_PERS_CONT" placeholder="" size="30" value="<?php echo $result['REF_PERS_CONT'];?>"></td>
            </tr>
            <tr>
                <th align="right">Poste occup&eacute; : </th>
                <td><input type="text" name="REF_POST_OCC" placeholder="" size="30" value="<?php echo $result['REF_POST_OCC'];?>"></td>
            </tr>
            <tr>
                <th align="right">T&eacute;l&eacute;phone : </th>
                <td><input type="text" name="REF_TEL" placeholder="" size="30" value="<?php echo $result['REF_TEL'];?>"></td>
            </tr>
            <tr>
                <th align="right">Email : </th>
                <td><input type="text" name="REF_EMAIL" placeholder="" size="30" value="<?php echo $result['REF_EMAIL'];?>">
                    <input type="hidden" name="id_ref" value="<?php echo $id_ref; ?>"/></td>
            </tr>
        </table>
