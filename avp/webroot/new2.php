...
// on insère le tuple (mysql_query) et au cas où, on écrira un petit message d'erreur si la requête ne se passe pas bien (or die)
        ...
        header('Location:index.php?url=index');
                  ...
                  echo  $class = 'Le code est incorrect'; // Le code est erroné
					header('Location:index.php?url=new2');
                }
            } else {
                echo $class = "Le champ n'a pas été remplit"; // Aucun code
                ...
                <fieldset>
                    ...
                    <table >
                        ...
                        <tr>
                            ...
                            <td><INPUT type="text" name="CANDIDAT_NUM_TEL" placeholder="" value="<?php if($ca_num_tel) echo $ca_num_tel; ?>" size="30" maxlength="15"/></td>
                        </tr>
                        <tr>
                            <th><div align="right">Num&eacute;ro de GSM : </div></th>
                            <td><INPUT type="text" name="CANDIDAT_NUM_GSM" placeholder="" value="<?php if($ca_num_gsm) echo $ca_num_gsm; ?>" size="30" maxlength="15"/></td>
                        </tr>
                        <tr>
                            <th><div align="right">Permis de conduire B :</div></th>
                    ...
                    <fieldset id="displayBlocFormation">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><SELECT required name="FORMATION_AN_FIN[]"  id="FORMATION_AN_FIN"  onchange="return test_annee();">
                                        <option value="">S&eacute;lectionnez</option>
                                        <?php for ($i=1960; $i<date('Y'); $i++):
                                            echo '<OPTION VALUE='.$i.'>'.$i.'</OPTION>';
                                        endfor; ?>
                            ...
                            <tr>
                                ...
                                <td><input type="file" class="required checkinput" accept="image/*,pdf" name="FORMATION_DIPLOME_FICHIER[]" value="<?php if($fo_diplome_fichier) echo $fo_diplome_fichier; ?>"></td>
                            </tr>
                        </table>
                    </fieldset>
                </div>
                        ...
                        <fieldset>
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><input type="file"  accept="image/*,pdf"  name="AUTRE_FORMATION_DIPLOME_FICHIER[]"></td>
                                </tr>
                            </table>
                        </fieldset>
                    </div>
                        ...
                        <fieldset>
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td><INPUT type="text" name="EXP_POSTE[]" placeholder="" size="30" maxlength="30"/></td>
                                </tr>
                                <tr>
                                    <th align="right">Nom et adresse de l'employeur   : </th>
                                    <td><INPUT type="text" name="EXP_ENT_NOM[]" placeholder="" size="30" maxlength="30"/></td>
                                </tr>
                                <tr>
                                    <th align="right">Domaine d'activit&eacute;   : </th>
                                    <td><INPUT type="text" name="EXP_SEC_ACT[]" placeholder="" size="30" maxlength="30"/></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><textarea  name="EXP_TACHE[]" cols="30" rows="5" id="EXP_TACHE[]"  placeholder="" ></textarea></td>
                                </tr>
                                <tr>
                                    <th align="right">Motif du d&eacute;part   : </th>
                                    <td><INPUT type="text" name="EXP_MOTIF_DEP[]" placeholder="" size="30" maxlength="50"/></td>
                                </tr>
                            </table>
                        </fieldset>
                    </div>
                ...
                <fieldset>
                    ...
                    <table>
                        <tr>
                            ...
                            <td><input type="file" class="required checkinput" accept="image/*,pdf" value="photo" name="CANDIDAT_DEMANDE_EMPLOI"></td>
                        </tr>
                        <tr>
                            <th align="right">CV : <font color=red>*</font></th>
                            <td><input type="file" class="required checkinput" accept="image/*,pdf" value="photo" name="CANDIDAT_CV"></td>
                        </tr>
                        <tr class="is_externe">
                            <th align="right">Certificat du dernier emploi : <font color=red>*</font></th>
                            <td><input type="file" class="required checkinput" accept="image/*,pdf" value="photo" name="CANDIDAT_CERTIFICAT_TRAVAIL"></td>
                        </tr>
                        <tr>
                            <th align="right">Photo : <font color=red>*</font></th>
                            <td><input type="file" class="required checkinput" accept="image/*" value="photo" name="CANDIDAT_PHOTO"></td>
                        </tr>
                        <tr class="is_externe">
                            <th align="right">Extrait de l'acte de naissance : <font color=red>*</font></th>
                            <td><input type="file" class="required checkinput" accept="image/*,pdf" value="acte_naissance" name="CANDIDAT_ACTE_NAISS"></td>
                        </tr>
                        <tr class="is_externe">
                            <th align="right">Livret de famille ou Fiche Famille : <font color=red>*</font></th>
                            <td><input type="file" class="required checkinput" accept="image/*,pdf" value="fiche_famille" name="CANDIDAT_FICHE_FAMILLE"></td>
                        </tr>
                        <tr class="is_externe">
                            <th align="right">Certificat de nationalit&eacute; : <font color=red>*</font></th>
                            <td><input type="file" class="required checkinput" accept="image/*,pdf" value="certif_nat" name="CANDIDAT_CERTIF_NAT"></td>
                        </tr>
                        <tr class="is_externe">
                            <th align="right">Certificat de domicile : <font color=red>*</font></th>
                            <td><input type="file" class="required checkinput" accept="image/*" value="certificat_domicile" name="CANDIDAT_CERTIF_DOMICILE"></td>
                        </tr>
                        <tr class="is_externe">
                            <th align="right">Certificat m&eacute;dical : <font color=red>*</font></th>
                            <td><input type="file" class="required checkinput" accept="image/*,pdf" value="certificat_medical" name="CANDIDAT_CERTIF_MEDICAL"></td>
                        </tr>
                        <tr class="is_externe">
                            <th align="right">Casier judiciaire : <font color=red>*</font></th>
                            <td><input type="file" class="required checkinput" accept="image/*,pdf" value="casier_judiciaire" name="CANDIDAT_CASIER_JUDICIAIRE"></td>
                        </tr>
                    </table>
                </fieldset>
            </div>
...
<tr>
    <td valign=top><img src="images/home/pixel.gif" width=1 height=25></td>
			...
			<tr>
                                            <th align="right">Entrez le code suivant : </th>
                                           <img src="webroot/captcha.php" alt="Captcha" id="captcha" />
										   <img src="images/reload.png" alt="Recharger l'image" title="Recharger l'image" style="cursor:pointer;position:relative;top:-7px;" onclick="document.images.captcha.src='webroot/captcha.php?id='+Math.round(Math.random(0)*1000)" />

                                            <td><?php echo '<input name="code" class="' . $class . '" type="text" />';?></td>
                                        </tr>

<p>
    <!--input id="SaveAccount" type="button" value="Submit form" /-->
    <input id="SaveAccount" type="submit" value="Soumettre" name="soumettre" style=" width:80px;margin-top:-5px; margin-left: 500px;" />
</p></debut>
