...
<tr class="fond4">
										...
										<tr>
										  <td>
											<div>
											  <fieldset>
                                              <legend>Lettre de motivation <font color=red>*</font></legend>
    ...
    <tr>
        ...
        <td><input name="code" id="id_code" type="text"/> <label id="id_error" class="error" style="display:none;">Code incorrect</label></td>
    </tr>
