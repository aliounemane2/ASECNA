...
$sql = "select * from CANDIDAT C,realisation D, Autre_Formation G, experience_professionnelle H, 
...
$sql = "select * from CANDIDAT C, famille F
where C.FK_UTIL_ID ='".$_SESSION['id_user']."' 
and F.fk_candidat_id=c.candidat_id";
											...
											<td>
												...
												<div style="border:solid;"id="monBlocFormation">
															...
															<table>
																<tr>
																	...
																	<td><SELECT name="FORMATION_CYCLE[]">
																		<option value="">S&eacute;lectionnez</option>
																		<OPTION value="<?php if( $user['FORMATION_CYCLE']=='Universitaires') echo  $user['FORMATION_CYCLE']; ?>" <?php if( $user['FORMATION_CYCLE']=='Universitaires') echo 'selected'; ?>  >Universitaires</OPTION>
																		<OPTION value="<?php if( $user['FORMATION_CYCLE']=='Secondaires') echo  $user['FORMATION_CYCLE']; ?>" <?php if( $user['FORMATION_CYCLE']=='Secondaires') echo 'selected'; ?>  >Secondaires</OPTION>
																	 </SELECT>
																	</td>
																</tr>
																<tr>
												  ...
												  <table>
													<tr>
													  <td>
													  <div id="sheepItForm_add"><a><span>Ajouter une formation<img class="delete" src="images/ajouter.png" width="16" height="16" border="0" /></span></a></div></td>
