...
$sql2 ='SELECT * FROM formation WHERE FK_CANDIDAT_ID='.$fk_candidat_id;
...
<article class="art-post art-article">
    <h3 class="art-postheader"> <a href="" >Accueil</a> > <a href="index.php?url=ressources">Ressources Humaines </a> ><a href="#">Liste des formations</a></h3>
    ...
    <div class="art-postcontent art-postcontent-0 clearfix">
		...
		<b><h3><a href="index.php?url=form2 ">Ajouter une formation</a></h3></b>
<!-- contenu à mettre  -->
...
//On sélectionne tout dans la table correspondant à l'id
                $result = mysql_query("DELETE FROM formation where FORMATION_ID =$id");
        ...
        <table cellpadding="0" cellspacing="0" border="1" class="display" id="dataTable">
            ...
            while ( $data = mysql_fetch_assoc($results) ) {
                ...
                <tr>
                    ...
                    <td><?php echo @$data['FORMATION_AN_FIN']; ?></td>
                    <td><?php echo $data['ETABLISSEMENT_NOM']; ?></td>
                    <td><?php echo $data['FORMATION_CYCLE']; ?></td>
                    <td><?php echo $data['FORMATION_DIPLOME']; ?></td>

                    <td><a href="index.php?url=modifierformation&id_formation=<?php echo $data['FORMATION_ID']?>"> <img src="images/edit.png" width="15" height="15" alt="Modifier"/></a><br/>
                    <a href="index.php?url=afficheformations&id_formation=<?php echo $data['FORMATION_ID']."&supp=3"?>"><img src="images/bouton_supprimer.png" width="15" height="15" alt="Modifier"/></a></td>
