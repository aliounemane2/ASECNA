...
?><tr>
    ...
    <td><a href="?url=listeCandidat&id=<?php echo $data['CANDIDAT_ID']; ?>&id_annonce=<?php echo @$_GET['id_annonce']; ?>" target="_blank"><img src="images/pdf_icon.png" width="18" height="18" alt="Voir"/></a> </td>
	<!--td><button class="openCandidat">Voir</button></td-->
	<!--<td>
	<ul class="actions">
...
<?php   
        ...
        <br/>
<!--a href="index.php?url=synthese&id_annonce=<?php echo $_GET['id_annonce']?> ">EXporter au format Excel</a-->
