...
<div class="container" style="text-align:justify;margin-left:-120px;">
...
<article class="art-post art-article">
    ...
    <ol class="breadcrumb" >
      ...
      <li class="active">Politique de ressources humaines</li>
   </ol>
...
<p>La sélection se faisant selon des critères objectifs, Nous vous encourageons vivement à lire les recommandations ci-après avant de débuter votre dépôt de candidature.</p>
                    ...
                    <input type="button" value="Liste des documents à fournir sous forme électronique." name="" class="btn-sm btn-info" />
                    </a></p>
...
<input type="button" value="Comment postuler ?" name="" class="btn-sm btn-info" />
                    </a></p>
