...
if(isset($_POST['envoyer'])&& (!empty($_POST['envoyer']))){
    ...
    $sql  = "select UTIL_ID as id_user , UTIL_ROLE as role, UTIL_LOGIN from utilisateurs where UTIL_LOGIN ='".$_POST['UTIL_LOGIN']."'AND UTIL_MDP='".sha1($_POST['UTIL_MDP'])."' AND active='oui'";
    $req  = mysql_query($sql);
...
if(isset($_SESSION['id_user'])){
    $req = mysql_query("SELECT * FROM postulation WHERE FK_UTIL_ID={$_SESSION['id_user']} ");
    $have_postulated = mysql_fetch_assoc($req);
}
?>
